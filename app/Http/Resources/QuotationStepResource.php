                            ...
                            function ($detail) use ($calculatedQuotation, $getTunjanganDisplayForBoth) {
                                ...
                                return [
                                    ...
                                    'coss' => [
                                        ...
                                        'personil_kaporlap_coss' => $cossData['provisi_kaporlap_coss'] ?? 0,
                                        'personil_devices_coss' => $cossData['provisi_devices_coss'] ?? 0,
                                        'personil_ohc_coss' => $cossData['provisi_ohc_coss'] ?? 0,
                                        'personil_chemical_coss' => $cossData['provisi_chemical_coss'] ?? 0,
                                        'total_personil' => $cossData['total_personil_coss'] ?? 0,
                                        'sub_total_personil' => $cossData['sub_total_personil_coss'] ?? 0,
                                        'total_base_manpower' => $cossData['total_base_manpower_coss'] ?? 0,
