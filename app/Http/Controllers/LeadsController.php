...
class LeadsController extends Controller
{
    ...
    public function listTerhapus()
    {
        ...
        return $this->successResponse($data, 'Data leads terhapus berhasil diambil');
    }
    /**
     * @OA\Get(
    ...
    public function childLeads($id)
    {
        ...
        return $this->successResponse($data, 'Data child leads berhasil diambil');
    }
    ...
    public function saveChildLeads(Request $request, $id)
    {
        ...
        if (!$leadsParent) {
            return $this->notFoundResponse('Parent lead tidak ditemukan');
        }
    ...
    public function leadsBelumAktif()
    {
        ...
        return $this->successResponse($data, 'Data leads belum aktif berhasil diambil');
    }
    ...
    public function availableQuotation()
    {
        ...
        return $this->successResponse($data, 'Data leads tersedia untuk quotation berhasil diambil');
    }
    ...
    public function import(ImportLeadRequest $request)
    {
        ...
        return $this->messageResponse('Import berhasil diproses');
    }
    ...
    {
        // Export logic here
        return $this->messageResponse('Export berhasil');
    }
    ...
    public function templateImport(Request $request)
    {
        ...
        return $this->messageResponse('Template berhasil diunduh');
    }
    ...
    public function getSalesKebutuhan($id)
    {
        ...
        if (!$lead) {
            ...
            return $this->successResponse(
                ...
                'Data sales per kebutuhan berhasil diambil'
            );
    }
    /**
     * @OA\Get(
    ...
    public function availableSales($id)
    {
            ...
            if (!in_array($user->cais_role_id, $allowedRoles)) {
                return $this->errorResponse('Anda tidak memiliki akses untuk melihat daftar tim sales', 403);
            }
            ...
            if (!is_numeric($lead->branch_id)) {
                return $this->errorResponse('Lead tidak memiliki branch_id yang valid', 400);
            }
            ...
            if ($user->cais_role_id == 31) { // Sales Leader
                ...
                if ($leaderTim) {
                    ...
                    return $this->successResponse([], 'Data tim sales berhasil diambil');
                }
            }
            ...
            // Custom envelope (extra top-level 'debug' key) — kept as raw response.
            return response()->json([
                'success' => true,
     ...
     * )
     */
    public function assignSales(AssignSalesRequest $request, $id)
    {
        // 1. Cek lead
        $lead = Leads::find($id);
        if (!$lead) {
     ...
     * )
     */
    public function removeSales(RemoveSalesRequest $request, $id)
    {
        $lead = Leads::find($id);
        if (!$lead) {
            return $this->notFoundResponse('Lead tidak ditemukan');
    ...
    public function getSpkByLead($id, Request $request)
    {
        ...
        if (!$lead) {
            ...
            // Custom envelope (extra top-level 'summary' key) — kept as raw response.
            return response()->json([
                'success' => true,
