...
class QuotationStepController extends Controller
{
     ...
     *             @OA\Examples(example="step_2", summary="Step 2 (version-1)/ Step 3: Detail Kontrak (version-2)", value={"mulai_kontrak": "2024-01-01 (Required)", "kontrak_selesai": "2024-12-31 (Required)", "tgl_penempatan": "2024-01-01 (Required)", "top": "Lebih Dari 7 Hari (Required)", "salary_rule": 1, "jumlah_hari_invoice": 14, "tipe_hari_invoice": "Kerja (Required if TOP > 7 Hari)", "evaluasi_kontrak": "Tahunan (Required)", "durasi_kerjasama": "12 Bulan (Required)", "durasi_karyawan": "12 Bulan (Required)", "evaluasi_karyawan": "Tahunan (Required)", "ada_cuti": "Ada (Required)", "cuti": {"Cuti Tahunan (Required if Ada)", "Cuti Menikah"}, "gaji_saat_cuti": "Prorate (Optional)", "prorate": 20, "shift_kerja": "Non Shift (Optional)", "hari_kerja": "Senin - Jumat (Required)", "jam_kerja": "08:00 - 17:00 (Required)", "edit": false}),
