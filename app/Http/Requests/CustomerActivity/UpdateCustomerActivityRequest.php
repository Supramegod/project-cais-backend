...
/**
 * Validasi untuk CustomerActivityController@update.
 *
 * Menerjemahkan getValidationRules(true): leads_id tidak divalidasi (tidak
 * dapat diubah), tgl_activity & tipe menjadi `sometimes`, dan aturan file
 * dihilangkan. FluentRule style.
 */
class UpdateCustomerActivityRequest extends BaseRequest
{
    ...
    {
        return [
            'tgl_activity'    => FluentRule::date()->sometimes()->required(),
            'tipe'            => FluentRule::string()->sometimes()->required()->in(['Telepon', 'Email', 'Meeting', 'Visit', 'Online Meeting']),
