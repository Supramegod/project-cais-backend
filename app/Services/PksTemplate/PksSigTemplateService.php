...
class PksSigTemplateService implements PksTemplateInterface
{
    ...
    {
        return '<p style="text-align:center;font-family:\'Arial\',sans-serif;font-size:12pt;font-weight:bold;margin:0 0 2pt 0">Pasal 7</p><p style="text-align:center;font-family:\'Arial\',sans-serif;font-size:12pt;font-weight:bold;margin:0 0 10pt 0">JANGKA WAKTU PERJANJIAN</p><ol style="text-align:justify;font-family:\'Arial\',sans-serif;font-size:12pt;margin:0 0 8pt 0;padding-left:22pt;line-height:1.4"><li style="margin-bottom:6pt">Masa berlakunya Perjanjian ini adalah terhitung dari <strong>Tanggal ….(bulan)…. (tahun) sampai dengan Tanggal ….(bulan)…..(Tahun) ..</strong> dan dapat ditinjau kembali oleh <strong>PARA PIHAK.</strong></li><li style="margin-bottom:6pt">Sebelum perjanjian ini berakhir <strong>PARA PIHAK </strong>akan memberitahukan secara tertulis maksud untuk memperpanjang atau tidak memperpanjang Perjanjian ini 30 hari sebelum berakhirnya perjanjian ini.</li><li style="margin-bottom:6pt">Apabila <strong>PARA PIHAK</strong> tidak memberitahukan hal tersebut maka secara otomatis perjanjian ini diperpanjang dengan mendasarkan pada ketentuan Upah Minimum Kabupaten/Kota yang berlaku.</li></ol>';
    }
