...
<body>
    <div class="wrapper">
        ...
        <div class="body">
            ...
            <p class="intro">
                Terdapat quotation yang telah selesai dibuat dan memerlukan persetujuan dari Anda sebelum dapat diproses
                lebih lanjut.
            </p>
            ...
            <table class="detail-card">
                <thead>
                    <tr>
                        <th colspan="2">Detail Quotation</th>
                    </tr>
                </thead>
                <tbody>
                    @if($namaPerusahaan)
            ...
            <div class="info-box">
                &nbsp;Email ini dikirim otomatis oleh <strong>Cais Shelter System</strong>. Harap tidak membalas email
                ini secara langsung.
            </div>
        </div>
