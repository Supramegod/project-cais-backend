...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            Bapak Hari Wahyudi</strong></p>

            <div class="alert-box">
                Terkait dengan batas waktu (lead time) Approval pada sistem CAIS, bersama ini kami melaporkan adanya keterlambatan proses pada dokumen berikut:
            </div>
            ...
            <p style="margin-top: 30px; font-weight: 600; border-bottom: 1px solid #eee; padding-bottom: 5px;">Detail Keterlambatan:</p>
            ...
            <table class="info-table">
                ...
                <tr>
                    ...
                    <td class="value">: > 24 Jam</td>
                </tr>
            </table>

            <p>Demi kelancaran operasional, dimohon kebijaksanaan Bapak untuk meninjau atau melakukan eskalasi lebih lanjut terkait dokumen tersebut.</p>
            
            <a href="https://caisshelter.pages.dev/quotation/view/{{ $data['quotation_id'] }}" class="button">Tinjau Dokumen di CAIS</a>
